...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, _______, _______, KW_SCR3, KW_SCR4, KW_SCR5, _______, RESET,      _______, KC_0,    _______, KC_1,    KC_2,    KC_3,   _______,  _______,
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_LBRC, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KW_XTRA, _______,    RESET,   _______, DEL_SPC, _______, _______, _______, _______, KC_RBRC,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case BSPC_4:
        ...
        if (record->event.pressed) {
            SEND_STRING(SS_TAP(X_BSPACE) SS_TAP(X_BSPACE) SS_TAP(X_BSPACE) SS_TAP(X_BSPACE));
        }
        return false;
