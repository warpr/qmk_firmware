...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DVORAK] = LAYOUT(
        ...
        SC_LSPO, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_MPLY,  KW_EMOJ,  KC_B,    KC_M,    KC_W,    KC_V,   KC_Z,    SC_RSPC,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, _______, _______, KW_SCR3, KW_SCR4, KW_SCR5, QK_BOOT,   QK_BOOT, _______, KC_1,    KC_2,    KC_3,   _______,  _______,
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_LBRC, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, QK_BOOT,  QK_BOOT,  DEL_SPC, _______, _______, _______, _______, KC_RBRC,
                                            _______, _______, KW_XTRA,  _______,  _______, _______
    ),

    [_ADJUST] = LAYOUT(
        _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______,
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,                    _______, KC_INS,  KC_PSCR, KC_SCRL, KC_PAUS, _______,
