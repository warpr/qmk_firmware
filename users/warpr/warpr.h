...
#define ____DVORAK_L1____  KC_ESC,   KC_QUOT,  KC_COMM,  KC_DOT,   KC_P,     KC_Y
#define ____DVORAK_L2____  KC_TAB,   KC_A,     KC_O,     KC_E,     KC_U,     KC_I
#define ____DVORAK_L3____  KC_LSPO,  KC_SCOLON, KC_Q,    KC_J,     KC_K,     KC_X

#define ____DVORAK_R1____  KC_F,     KC_G,     KC_C,     KC_R,     KC_L,     KC_BSPACE
...
#define ____LOWER__L3____  KC_LBRC,  KC_COLN,  KC_DQUO,  KC_GRAVE, KC_TILD,  _______

#define ____LOWER__R1____  KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_GT
#define ____LOWER__R2____  KC_CIRC,  KC_AMPR,  KC_ASTR,  _______,  KC_KP_PLUS, KC_RCBR
#define ____LOWER__R3____  KC_QUES,  KC_SLASH, KC_EQL,   KC_BSLASH, KC_PIPE, KC_RBRC
...
#define ____RAISE__R3____  _______, KC_DEL, KC_BSPACE, _______, _______, _______
